 ...
 */
Mobile.verifyElementExist(findTestObject('Object Repository/mobileApp/android.view.ViewGroup - Alert', [('text') : 'Username is required']), 
    1)

Mobile.takeScreenshotAsCheckpoint('usernameRequired')
