...
Mobile.setText(findTestObject('Object Repository/mobileApp/android.widget.EditText - Username'), 'locked_out_user', 0)
 ...
 */
Mobile.verifyElementExist(findTestObject('Object Repository/mobileApp/android.view.ViewGroup - Alert', [('text') : 'Sorry, this user has been locked out.']), 
    1)

Mobile.takeScreenshotAsCheckpoint('lockedOutUser')
