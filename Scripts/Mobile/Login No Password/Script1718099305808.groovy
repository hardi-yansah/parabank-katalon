...
//Mobile.setEncryptedText(findTestObject('Object Repository/mobileApp/android.widget.EditText - Password'), 'qcu24s4901FyWDTwXGr6XA==', 0)
 ...
 */
Mobile.verifyElementExist(findTestObject('Object Repository/mobileApp/android.view.ViewGroup - Alert', [('text') : 'Password is required']), 
    1)

Mobile.takeScreenshotAsCheckpoint('passwordRequired')
