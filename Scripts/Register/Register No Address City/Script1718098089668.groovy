 ...
 * firstName) + ' ') + lastName)
 */
WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank-Register/span_Alert', [('forms') : 'address.city']), 
    'City is required.')

WebUI.takeFullPageScreenshotAsCheckpoint('cityNameRequired')