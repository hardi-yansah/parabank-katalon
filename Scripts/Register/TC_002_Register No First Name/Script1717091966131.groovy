 ...
 * firstName) + ' ') + lastName)
 */
WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank-Register/span_Alert', [('forms') : 'firstName']), 
    'First name is required.')

WebUI.takeFullPageScreenshotAsCheckpoint('firstNameRequired')
