 ...
 * firstName) + ' ') + lastName)
 */
WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank-Register/span_Alert', [('forms') : 'username']), 
    'Username is required.')

WebUI.takeFullPageScreenshotAsCheckpoint('userRequired')