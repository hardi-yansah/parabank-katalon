 ...
 * firstName) + ' ') + lastName)
 */
WebUI.verifyElementText(findTestObject('Object Repository/Page_ParaBank-Register/span_Alert', [('forms') : 'address.street']), 
    'Address is required.')

WebUI.takeFullPageScreenshotAsCheckpoint('streetNameRequired')